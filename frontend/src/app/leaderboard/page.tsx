...
export default function Leaderboard() {
  ...
  return (
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '2rem 1rem' }}>
      <section role="region" aria-label="Top traders leaderboard">
        ...
        <div style={{
          ...
          <table
            aria-label="Top prediction market traders ranking table"
            ...
            <tbody>
              {topTraders.map((trader, idx) => (
                <tr
                  ...
                  style={{ borderBottom: idx < topTraders.length - 1 ? '1px solid #334155' : 'none' }}
                >
