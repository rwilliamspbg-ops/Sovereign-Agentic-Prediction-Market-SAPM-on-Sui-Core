...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex min-h-[44px] min-w-[44px] items-center justify-center font-semibold rounded-lg transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
