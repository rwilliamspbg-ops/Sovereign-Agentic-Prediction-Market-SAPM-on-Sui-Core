...
export SAPM_BACKPRESSURE_HIGH_WATERMARK_PCT=85
export SAPM_BACKPRESSURE_LOW_WATERMARK_PCT=60
export SAPM_CIRCUIT_BREAKER_LATENCY_THRESHOLD_MS=5
export SAPM_CIRCUIT_BREAKER_WINDOW_SIZE=32
export SAPM_CIRCUIT_BREAKER_COOLDOWN_TICKS=64
cargo run --manifest-path rust-datapath/Cargo.toml -- validate
```
